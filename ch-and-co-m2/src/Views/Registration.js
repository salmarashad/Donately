...
function Registration(props) {
	...
	return (
		<div className="h-max flex flex-col items-center -mt-12 pb-8">
			<LogoSVG
				className="w-48 mb-6 cursor-pointer"
				...
				{step === 0 && (
					<div className="w-full flex gap-2 text-farahgreen-700">
						<button
							className={
								form === "donor"
									? "text-base rounded-md border-2 w-1/2 py-1 font-semibold border-farahgreen-400 bg-farahgreen-300"
					...
					{step === 0 && (
						<div className="text-center text-sm">
							<p>
								Returning user?
								<span
									className="underline cursor-pointer w-max mx-auto italic ml-1"
