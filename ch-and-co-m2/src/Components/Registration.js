    ...
    return(
        <div className='h-max flex flex-col items-center -mt-12 pb-8'>
            ...
            <div className='flex flex-col items-start w-[500px] gap-2'>
                {step === 0 && <div className="w-full flex gap-2 text-farahgreen-700">
                    <button 
                ...
                <div className="flex flex-col justify-center bg-white rounded-md w-full p-6 shadow-md gap-4">
                    <RegistrationForm type={form} setPage={props.setPage} step={step} setStep={setStep} />
                    {/*Redirect to login*/}
                    {step === 0 && <div className='text-center text-sm'>
                        <p>Returning user?
