				...
				<form className="flex flex-col w-full">
							...
							<div className="flex flex-col">
								<label className="label">
									...
									{userType === "organization" ? (
										<input
											type="text"
											value={orgDataTmp.address}
											placeholder="Type here..."
											className="text-input"
											onChange={(e) =>
												handleOrgChange("address", e.target.value)
											}
										/>
									) : (
										<input
											type="text"
											value={formDataTmp.address}
											placeholder="Type here..."
											className="text-input"
											onChange={(e) =>
								...
								<div className="grid grid-cols-2 gap-x-4">
									<label className="label">
										...
										{userType === "organization" ? (
											<input
												type="text"
												value={orgDataTmp.governorate}
												placeholder="Type here..."
												className="text-input"
												onChange={(e) =>
													handleOrgChange("governorate", e.target.value)
												}
											/>
										) : (
											<input
												type="text"
												value={formDataTmp.governorate}
												placeholder="Type here..."
												className="text-input"
												onChange={(e) =>
									...
									<label className="label">
										...
										{userType === "organization" ? (
											<input
												type="text"
												value={orgDataTmp.area}
												placeholder="Type here..."
												className="text-input"
												onChange={(e) =>
													handleOrgChange("area", e.target.value)
												}
											/>
										) : (
											<input
												type="text"
												value={formDataTmp.area}
												placeholder="Type here..."
												className="text-input"
												onChange={(e) =>
					...
					{userType === "teacher" && (
						<div>
							...
							<label className="label">
								Number of pro-bono classes you can teach a month
								<Counter
									val={teacherDataTmp.numCases}
									setter={handleTeacherChange}
									valName="numCases"
								/>
							</label>
							...
							<h2 className="text-lg font-semibold mb-1">
								Teaching Post Location
							</h2>
							<label className="label">
								Address
								<input
									type="text"
									value={teacherDataTmp.address}
									placeholder="Type here..."
									className="text-input"
									onChange={(e) =>
										handleTeacherChange("address", e.target.value)
									}
								/>
							</label>
							<div className="flex flex-col gap-y-4">
								<div className="flex flex-row gap-x-4">
									...
									<label className="label">
										...
										<input
											type="text"
											value={teacherDataTmp.governorate}
											placeholder="Type here..."
											className="text-input"
											onChange={(e) =>
					...
					{userType === "doctor" && (
						<div>
							...
							<label className="label">
								Number of pro-bono cases you can take a month
								<Counter
									val={doctorDataTmp.numCases}
									setter={handleDoctorChange}
									valName="numCases"
								/>
							</label>
							...
							<div className="flex flex-col gap-y-4">
								<div className="flex flex-row gap-x-4">
									<label className="label">
										...
										<input
											type="text"
											value={doctorDataTmp.area}
											placeholder="Type here..."
											className="text-input"
											onChange={(e) =>
												handleDoctorChange("area", e.target.value)
											}
										/>
									</label>
									<label className="label">
										...
										<input
											type="text"
											value={doctorDataTmp.governorate}
											placeholder="Type here..."
											className="text-input"
											onChange={(e) =>
					...
					{(userType === "doctor" ||
						...
						<>
							<hr className="border-t-2 my-4" />
							<h2 className="text-lg font-semibold mb-1">
								{userType === "organization" ? "Documents" : "Qualifications"}
							</h2>
							<label className="label" htmlFor="pdf">
								{userType === "organization" ? "Proof of Identity" : "CV"}
								<input
									id="pdf"
									type="file"
									name="pdf"
					...
					{submition === true ? (
						<div className=" self-center text-farahorange-600">
					...
					<button
						...
						disabled={
							Object.values(formDataTmp).includes("") ||
